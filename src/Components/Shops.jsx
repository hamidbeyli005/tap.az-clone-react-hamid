...
function Shops() {
  ...
  // magazaları filtrleme
  /*   Array.forEach((item) =>
    item.products.forEach((product) =>
      shops.includes(product.shop) ? null : setShops([...shops, product.shop])
    )
  );  */
  // magazaları filtrleme
    ...
    <div className="store_component">
      <div className="shops">
        <div className="header_top">
          ...
          <div className="new">
            <img
              src="data:image/svg+xml;charset=utf-8,<svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 20 20'><defs><linearGradient id='s685kxuuta' x1='-107.787%25' x2='103.635%25' y1='-137.718%25' y2='143.955%25'><stop offset='0%25' stop-color='%23FF236E'/><stop offset='50.321%25' stop-color='%23FF4961'/><stop offset='100%25' stop-color='%23FF4F08'/></linearGradient></defs><g fill='none' fill-rule='evenodd'><g><g><g transform='translate%28-340 -213%29 translate%280 192%29 translate%28340 21%29'><circle cx='10' cy='10' r='10' fill='url%28%23s685kxuuta%29'/><path fill='%23FFF' fill-rule='nonzero' stroke='%23FFF' stroke-width='.714' d='M14.497 9.46H10.36V5.503c0-.2-.161-.36-.36-.36-.199 0-.36.16-.36.36V9.46H5.503c-.199 0-.36.161-.36.36 0 .2.161.36.36.36H9.64v4.317c0 .2.161.36.36.36.199 0 .36-.16.36-.36V10.18h4.137c.199 0 .36-.16.36-.36 0-.199-.161-.36-.36-.36z'/></g></g></g></g></svg>"
              alt=""
            />
          </div>
        </div>
      ...
      <ul className="store_container">
        {Stores.map((store) => (
          <li key={store} className="shop_card">
            <Link to={`/shops/${store.name}`}>
              ...
              <div className="card_right">
                ...
                <div className="count">101 elan</div>
              </div>
            </Link>
          </li>
        ))}
